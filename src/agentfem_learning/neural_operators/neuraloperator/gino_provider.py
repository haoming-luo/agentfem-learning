...
def _lower_gino(model, request):
    ...
    options = GINOTrainingOptions(
        ...
        output_weighting_function=request.option("output_weighting_function"),
        output_weighting_scale=float(request.option("output_weighting_scale", 1.0)),
...
GINO_PROVIDER = StepProvider(
    ...
    option_contract=StepOptionContract(
        accepted=(
            ...
            "input_radius",
            "output_radius",
            "output_weighting_function",
            "output_weighting_scale",
            "epochs",
            "batch_size",
            "learning_rate",
            "weight_decay",
